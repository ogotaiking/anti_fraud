#Author WillKoehrsen
#https://github.com/WillKoehrsen/feature-selector/blob/master/feature_selector.py
    ...
    def identify_zero_importance(self, task, eval_metric=None, 
        ...
        for _ in range(n_iterations):
            ...
            if task == 'classification':
                model = lgb.LGBMClassifier(n_estimators=1000, learning_rate = 0.05, verbose = -1,nthread=-1)

            elif task == 'regression':
                model = lgb.LGBMRegressor(n_estimators=1000, learning_rate = 0.05, verbose = -1,nthread=-1)
